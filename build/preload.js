...
Electron.contextBridge.exposeInMainWorld('electronAPI', {
    onConnectionUpdate: (callback) => Electron.ipcRenderer.on('connections-update', (_event, value) => callback(value)),
    onConnectionError: (callback) => Electron.ipcRenderer.on('connections-error', (_event, value) => callback(value)),
    removeAllListeners: () => {
